export default {
  ...
  'address.map': 'Show address on Google Maps',
  ...
  'address.switch.secondary': 'Secondary',
  ...
  'address.showMap': 'Show on the map',
  'address.assign': 'Assign address',
  'address.unassign': 'Un-assign address',
  'address.selected': 'Address was already assigned'
};
